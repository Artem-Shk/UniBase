...
namespace UniBase.CORE
{
    public class JournalFabric
    {
        ...
        public JournalFabric(DBManager manager, int semestr, int faculityId = 28, string startDate = "2023-12-27T00:00:00",
            string EndDate = "2024-01-25T00:00:00", int pageNum = 0, string name = "")
        {
        ...
        {
            List<JournalHeaderDB> resultDB = await _data_base_manager.GetJournalHeaderData(faculityId, _semestr, 
                                                                                            _startDate, _EndDate,  _pageNum, _name);
